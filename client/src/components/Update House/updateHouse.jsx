      ...
      <div className="container">
        ...
        <div className="sections">
          <div className="info">
            ...
            <select defaultValue={""} name="type" id="type" onChange={handleChange}>
          ...
          <div className="details">
            ...
            <input type="text" name="BHK" defaultValue={data.BHK} onChange={handleChange} />
            ...
            <input type="number" defaultValue={data.price} onChange={handleChange} name="price" />
          </div>
        </div>
      </div>
    </div>
